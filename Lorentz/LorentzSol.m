...
%imwrite(I,'E:\Matlab 2012\Encryption via ChenLee\ChenOutput\Encrypted.bmp'); 
%VedioWrite
drawnow; 
...
%imwrite(I1,'E:\Matlab 2012\Encryption via ChenLee\ChenOutput\Decrypted.bmp'); 

%VedioWrite
drawnow; 
 
% 错误密码解密后的图像x1=1.1840000001，y1=1.3627000001，z1=1.2519000001 
I2=I;%imread('E:\Matlab 2012\Encryption via ChenLee\ChenOutput\Encrypted.bmp'); 
...
%imwrite(I2,'E:\Matlab 2012\Encryption via ChenLee\ChenOutput\Decrypted2.bmp'); 
drawnow; 
